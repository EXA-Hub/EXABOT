...
client.on("ready", () => {
    ...
    const wok = new WOKCommands(client, {
        ...
        .setCategorySettings(require(path.join(__dirname, 'data/CategorySettings.json')))
    ...
    wok.on('databaseConnected', async(connection, state) => {
        ...
        const GiveawayManagerWithOwnDatabase = require('./functions/GiveawayManagerWithOwnDatabase')(connection);
