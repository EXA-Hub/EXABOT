module.exports = {
    ...
    callback: async({
        ...
        const nickName = message ? args[1] : interaction.options.getString('الإسم_الجديد');
        const { MessageEmbed } = require("discord.js");
        let nickUser = (message ?
        ...
        if (!member.permissions.has("MANAGE_NICKNAMES")) return '❌ | أنت لا تمتلك صلاحية!';
